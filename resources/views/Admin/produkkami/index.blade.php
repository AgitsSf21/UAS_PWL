            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="px-5">
                        ...
                        <div class="row">
                            <div class="col">
                                <a href="{{ route('product-kami.create') }}" class="btn btn-primary btn-md mb-4">Create
                                    Jenis
                                    Productk</a>
                                    ...
                                    <tbody>
                                        @foreach ($productkami as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- ini button edit --}}
                                                    <a href="{{ route('product-kami.edit', $item->id) }}"
                                                        class="btn btn-primary btn-sm">Edit</a>

                                                    {{-- ini button delete --}}
                                                    <form action="{{ route('product-kami.destroy', $item->id) }}"
